...
if __name__ == '__main__':
    ...
    input_param.add_argument('--fiducial_dir', type=str, help='directory with the target data and predicted data', default='/home/luciacev/Desktop/training ios files/all data/output')
